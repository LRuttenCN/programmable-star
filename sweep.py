...
MAX_BRIGHTNESS = 0.3    # maximum brightness of the LED's (between 0 and 1)
...
DURATION_IN_SECONDS = 0.2 # How long should the animation run (use None) to loop indefinitely
